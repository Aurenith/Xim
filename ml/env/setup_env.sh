...
if conda env list | grep -q "^xim-forest-surveillance-ml "; then
    echo "WARNING: Environment 'xim-forest-surveillance-ml' already exists. Skipping creation."
else
...
conda activate xim-forest-surveillance-ml
...
echo "    conda activate xim-forest-surveillance-ml"
echo ""
